import { Alert, Button, FormControl, FormGroup, FormHelperText, IconButton, Input, InputAdornment, InputLabel, TextField, Typography } from "@mui/material";
    ...
    return (
      <>
        ...
        <TextField
          ...
          InputProps={{
            endAdornment: (this.renderShowPasswordIcon('showPassword')),
          }}
        />
        <div style={{ display: 'flex', justifyContent: 'space-between', margin: '0px 32px 0px 32px' }}>
          <NavigateButton
            url="/register"
            disableRipple
    ...
    return (
      <>
        ...
        <TextField
          ...
          InputProps={{
            endAdornment: (this.renderShowPasswordIcon('showConfirmPassword')),
          }}
          // TODO add password regex validation
        />
        <div style={{ display: 'flex', justifyContent: 'space-between', margin: '0px 32px 0px 32px' }}>
  ...
  render() {
    return (
      <div className={"login-container"}>
        ...
        <div className={`${this.props.isRegister ? 'register-panel' : 'login-panel'} main-panel`}>
          <Typography className={'login-panel-main-title'}>
            {this.props.isRegister ? "Sign up with readit" : "Login with Readit"}
          </Typography>
